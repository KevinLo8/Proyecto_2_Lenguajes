...
public class PanelErroresLexicos extends JPanel {
    ...
    public PanelErroresLexicos(FramePrincipal framePrincipal, int panelHeigt, int panelWidth, List<Token> errores) {
    ...
    private void initComponents() {
        ...
        String[] titulos = { "Token", "Fila", "Columna", "Descripción" };
    ...
    private String[][] agregarData(Token tokenError, String[][] data) {
        ...
        retorno[data.length][1] = String.valueOf(tokenError.getFila());
        retorno[data.length][2] = String.valueOf(tokenError.getColumna());
        retorno[data.length][3] = tokenError.getDescripcion();
