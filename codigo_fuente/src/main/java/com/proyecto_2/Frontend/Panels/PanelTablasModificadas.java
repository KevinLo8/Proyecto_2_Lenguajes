...
public class PanelTablasModificadas extends JPanel {
    ...
    public PanelTablasModificadas(FramePrincipal framePrincipal, int panelHeigt, int panelWidth, List<Token> tablas) {
    ...
    private void initComponents() {
        ...
        String[] titulos = { "Tabla Modificada", "Tipo de Modificación", "Fila", "Columna" };
